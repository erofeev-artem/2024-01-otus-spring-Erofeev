...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, OrderMessage> producerFactory(ObjectMapper mapper) {
        var props = new HashMap<String, Object>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);

        var kafkaProducerFactory = new DefaultKafkaProducerFactory<String, OrderMessage>(props);
    ...
    @Bean
    public DataProducer dataSender(NewTopic topic, KafkaTemplate<String, OrderMessage> kafkaTemplate) {
